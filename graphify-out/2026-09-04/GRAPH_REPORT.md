# Graph Report - my-shop  (2026-09-04)

## Corpus Check
- 445 files · ~351,425 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2853 nodes · 4651 edges · 218 communities (145 shown, 51 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 56 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e970fbb`
...
4. `dbErrorResponse()` - 30 edges
5. `Проект my-shop - Техническая документация` - 29 edges
6. `NovaPostError` - 25 edges
7. `strOrNull()` - 22 edges
8. `compilerOptions` - 18 edges
9. `File Structure (deliverable map)` - 17 edges
10. `base()` - 16 edges
...
Cohesion: 0.10
Nodes (21): LiqPayConfig, decodeLiqPayData(), ApplyResult, buildCheckoutPayload(), CallbackDeps, CallbackOrderRow, CallbackOutcome, CheckoutPayloadInput (+13 more)
...
Cohesion: 0.07
Nodes (29): Checkout / Orders (миграции 006–008), Nova Post — состояние модуля (2026-09), Архитектура Supabase, Важные правила для будущих изменений, Етап 16: Security hardening (2026-08-27), Известные ограничения (осознанные), Интеграция Yugcontract (этап 1: read-only preview, 2026-08), Интеграция Yugcontract (этап 2: импорт выбранного ассортимента, 2026-08) (+21 more)

### Community 10 - "import-plan.ts"
Cohesion: 0.07
Nodes (29): bareKey(), BrandPlan, buildBrandPlan(), buildCategoryPlan(), CategoryCreateOp, CategoryPlan, CategoryUpdateOp, depthsInSelection() (+21 more)

### Community 11 - "normalize.ts"
Cohesion: 0.07
Nodes (30): CategoriesResponse, YugcontractCategoriesPage(), PreviewResponse, YugcontractAdminPage(), brandKeys(), buildCrossAnalysis(), CATEGORY_ID_KEYS, CATEGORY_NAME_KEYS (+22 more)

### Community 12 - "catalog/page.tsx"
Cohesion: 0.14
Nodes (22): CatalogFilters(), ActiveChip, buildActiveChips(), catalogHeading(), CatalogPage(), catalogPageUrl(), firstParam(), generateMetadata() (+14 more)
...
Cohesion: 0.05
Nodes (53): Home(), buildSearchConditions(), CATALOG_DICTIONARY_TTL_SECONDS, CATALOG_PUBLIC_READ_TTL_SECONDS, CatalogCardImage, CatalogCardProduct, CatalogCardRow, CatalogPage (+45 more)
...
Cohesion: 0.06
Nodes (38): ALLOWED_TRANSITIONS, fetchOrderDetailsApi(), fetchOrdersApi(), formatDate(), ItemRow, OrderDetails, OrderListRow, OrdersAdminPage() (+30 more)
...
### Community 22 - "favorites/page.tsx"
Cohesion: 0.15
Nodes (16): metadata, FavoriteButton(), FavoritesBadge(), HeartIcon(), RemoveFavoriteButton(), SiteHeader(), FavoritesPage(), FavoritesContext (+8 more)

### Community 23 - "(home)/page.tsx"
Cohesion: 0.15
Nodes (14): metadata, Announcements(), CONTACT_EMAIL, INFO_LINKS, SiteFooter(), SiteFooterProps, metadata, revalidate (+6 more)

### Community 24 - "tmp-verify-stage.ts"
Cohesion: 0.12
Nodes (17): byYc, client, DANGER, dangerSamples, descPairs, descStats, headCount(), ids (+9 more)

### Community 25 - "ttn/route.ts"
Cohesion: 0.22
...
Cohesion: 0.13
Nodes (22): TYPE_STYLES, base(), BoxIcon(), CartIcon(), ChevronDownIcon(), ChevronRightIcon(), FilterIcon(), IconProps (+14 more)

### Community 40 - "telegram.ts"
Cohesion: 0.06
Nodes (43): POST(), SanitizedItem, sanitizeShippingInfo(), supabase, ALLOWED_KEYS, CheckoutDelivery, CheckoutDeliveryServiceType, displayText() (+35 more)

### Community 41 - "yugcontract/categories/route.ts"
Cohesion: 0.40
Nodes (9): GET(), maxDuration, getCategoriesCatalog(), loadOnce(), buildCategoryTree(), detectCategoryFields(), extractCategoryRows(), isPlainObject() (+1 more)
...
Cohesion: 0.26
Nodes (9): SORT_OPTIONS, SortSelectInner(), buildFilterSearchParams(), buildFilterUrl(), buildSortSearchParams(), FilterDraft, PRESERVED_KEYS, setIfPresent() (+1 more)

### Community 47 - "liqpay-signature.ts"
Cohesion: 0.36
...
### Community 50 - "content-du-mapping.ts"
Cohesion: 0.22
...
### Community 57 - "FeedbackModal.tsx"
Cohesion: 0.17
...
### Community 58 - "schema-org.ts"
Cohesion: 0.21
Nodes (13): ProductJsonLd(), availabilityUrl(), BreadcrumbCategoryLike, buildCatalogBreadcrumbJsonLd(), buildProductJsonLd(), ProductLike, ReviewSummaryLike, serializeJsonLd() (+5 more)
...
Cohesion: 0.11
Nodes (10): anon, cases, root, client, root, client, root, anon (+2 more)

### Community 62 - "tmp-content-refetch-dryrun.ts"
Cohesion: 0.04
Nodes (53): afterContentRun, afterPriceRun, BOILERPLATE_MARKERS, both, client, contentRows, deduped, detail (+45 more)

### Community 63 - "announcements.ts"
Cohesion: 0.15
Nodes (17): AdminAnnouncementsPage(), callApi(), Draft, EMPTY_DRAFT, TYPE_BADGE, Announcement, ANNOUNCEMENT_MESSAGE_MAX, ANNOUNCEMENT_TITLE_MAX (+9 more)
...
Cohesion: 0.14
Nodes (17): clampInt(), GET(), maxDuration, parseIso(), ReconciliationOrderRow, mapLiqPayStatus(), sameMoneyCents(), classifyReconcileRow() (+9 more)
...
### Community 75 - "(dashboard)/categories/page.tsx"
Cohesion: 0.33
...
### Community 82 - "tmp-liqpay-payload-check.ts"
Cohesion: 0.20
...
### Community 86 - "ProductCard.tsx"
Cohesion: 0.31
Nodes (6): availabilityLabel(), ProductCard(), ProductCardData, formatPrice(), fracFormat, intFormat

### Community 87 - "escapeIlikePattern"
Cohesion: 0.18
...
### Community 89 - "import-run.ts"
Cohesion: 0.10
Nodes (30): maxDuration, POST(), maxDuration, POST(), CheckpointRow, GET(), buckets, checkRateLimit() (+22 more)

### Community 90 - "admin/orders/route.ts"
Cohesion: 0.25
Nodes (6): GET(), sanitizeSearchTerm(), STATUSES, GET(), STATUS_FILTERS, StatusFilter

### Community 91 - "Yugcontract Sync в WSL2 (systemd timer)"
Cohesion: 0.17
Nodes (11): 1. Установить таймер, 2. Проверить статус, 3. Запустить вручную (вне расписания), 4. Включить / выключить, 5. Удалить, 6. Где логи, 7. Запуск через coding-agent, Yugcontract Sync в WSL2 (systemd timer) (+3 more)

### Community 92 - "tmp-verify-033-034.mts"
Cohesion: 0.25
Nodes (6): anon, CATALOG_TABLES, missing, NOTE: information_schema / pg_catalog are NOT exposed via PostgREST, root, service
...
Cohesion: 0.50
Nodes (3): graphify, This is NOT the Next.js you know, Yugcontract Sync (запуск агентом)
...
### Community 141 - "CheckoutForm.tsx"
Cohesion: 0.05
Nodes (56): CheckoutForm(), DELIVERY_TYPES, DeliveryType, fetchDivisionsApi(), isLockerCategory(), NpDivision, NpSettlement, NpStreet (+48 more)
...
### Community 143 - "tmp-du-mapping-audit.ts"
Cohesion: 0.06
Nodes (26): brandName, brands, byVerdict, client, deduped, duProducts, DuRow, feedById (+18 more)

### Community 144 - "tmp-probe-admin-search.ts"
Cohesion: 0.33
Nodes (3): client, root, SCALAR_FIELDS

### Community 145 - "tmp-verify-orders-revoke.mts"
Cohesion: 0.40
Nodes (3): anon, root, service

### Community 146 - "cart/page.tsx"
Cohesion: 0.15
Nodes (13): POST(), supabase, availabilityLabel(), CartPage(), EmptyState(), CartPreviewLine, fetchCartPreview(), FetchHandlers (+5 more)

### Community 149 - "tmp-du-mapping-verdicts.ts"
Cohesion: 0.08
Nodes (18): AuditRow, auditRows, client, duProducts, feedBrandByBase, ImageRow, imagesByProduct, ParamPair (+10 more)

### Community 150 - "tmp-probe-search-grammar.ts"
Cohesion: 0.33
Nodes (3): client, q1, root

### Community 151 - "tmp-plan-split.ts"
Cohesion: 0.10
Nodes (17): client, deduped, duNotPlanned, duOps, duPlannedIds, duProducts, { goods: rawGoods }, planFull (+9 more)

### Community 152 - "RecentProducts.tsx"
Cohesion: 0.27
...
### Community 163 - "tmp-postverify-run20.ts"
Cohesion: 0.11
Nodes (14): client, duAll, duTouched, EXCLUDED, filled, ProductRow, products, regTouched (+6 more)
...
Cohesion: 0.24
Nodes (8): LoggedRequest, matchRows(), orExprMatches(), reqLog, Row, ROWS, server, stripOuterParens()

### Community 170 - "brands/page.tsx"
Cohesion: 0.27
...
### Community 172 - "tmp-plan-split-staging.ts"
Cohesion: 0.15
Nodes (12): client, duOps, fmtInt(), plan, ProductRow, products, regOps, root (+4 more)
...
### Community 174 - "tmp-manual-images.ts"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (29): ProductDescription(), htmlToPlainText(), isPlaceholderDescription(), NOTE: htmlToPlainText/isPlaceholderDescription live here (not in seo.ts), ResolvedDescription, resolveProductDescription(), shouldRenderDescriptionSection(), BOILERPLATE_MARKERS (+21 more)
...
Cohesion: 0.15
Nodes (18): AdminCategoryMultiSelect(), CategorySelect(), Category, applyCategorySeoMetadata(), CategorySeoOverride, getCategorySeo(), listDirectChildren(), OVERRIDES (+10 more)

### Community 183 - "selection.ts"
Cohesion: 0.15
...
Cohesion: 0.21
Nodes (20): POST(), DELETE(), PUT(), POST(), DELETE(), PUT(), DELETE(), POST() (+12 more)

### Community 192 - "requireAdminApi"
Cohesion: 0.12
Nodes (28): DELETE(), GET(), PATCH(), POST(), readJson(), DELETE(), PUT(), POST() (+20 more)

### Community 195 - "[slug]/page.tsx"
Cohesion: 0.11
Nodes (21): ImageRow(), GalleryImage, ProductGallery(), dateFormatter, pluralReviews(), ProductReviews(), RelatedProducts(), fetchReviewSummary() (+13 more)
...
### Community 213 - "tmp-verify-rrp.ts"
Cohesion: 0.29
...
### Community 223 - "htmlToPlainText"
Cohesion: 0.67
Nodes (3): htmlToPlainText(), isKnownBoilerplate(), isPlaceholder()
...
## Knowledge Gaps
- **1226 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `type`, `/home/loxord/.local/bin/graphify-mcp`, `graphify-out/graph.json` (+1221 more)
...
- **Why does `requireAdminApi()` connect `requireAdminApi` to `import-run.ts`, `admin-list.ts`, `products/route.ts`, `delivery-cost.ts`, `reconciliation.ts`, `yugcontract/categories/route.ts`, `images/route.ts`, `preview/route.ts`, `escapeIlikePattern`, `ttn/route.ts`, `admin/orders/route.ts`, `admin-api.ts`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `enforceRateLimit()` connect `import-run.ts` to `delivery-cost.ts`, `telegram.ts`, `yugcontract/categories/route.ts`, `liqpay-config.ts`, `success/page.tsx`, `cart/page.tsx`, `preview/route.ts`, `api/reviews/route.ts`, `FeedbackModal.tsx`, `NovaPostError`, `getNovaPostClient`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `isUuid()` connect `requireAdminApi` to `products/route.ts`, `delivery-cost.ts`, `images/route.ts`, `api/reviews/route.ts`, `ttn/route.ts`, `admin-api.ts`?**
