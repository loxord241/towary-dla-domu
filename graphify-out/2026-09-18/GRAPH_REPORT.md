...
Cohesion: 0.11
Nodes (18): LIQPAY_CHECKOUT_URL, LiqPayConfig, createLiqPaySignature(), decodeLiqPayData(), verifyLiqPaySignature(), ApplyResult, buildCheckoutPayload(), CallbackDeps (+10 more)
...
Cohesion: 0.06
Nodes (25): ContentIssue, count(), env, seen, client, deduped, descAll, descMatched (+17 more)
...
Cohesion: 0.08
Nodes (34): DU_BASE_TO_DU, DU_CONTENT_BY_DU_YC, DU_CONTENT_PAIRS, duBaseIdOf(), DuContentPair, assertImageUpdateFields(), assertContentFields(), claimNextContentBatch() (+26 more)
...
Cohesion: 0.06
Nodes (52): maxDuration, POST(), maxDuration, POST(), bareKey(), BrandPlan, buildBrandPlan(), buildCategoryPlan() (+44 more)
...
Cohesion: 0.06
Nodes (34): IMAGE_UPDATE_FIELDS, ImageInsertOp, ImagePlan, ImagePlanInputProduct, ImageUpdateOp, isExternalImportedImage(), planImageOps(), ProductImageRow (+26 more)
...
Cohesion: 0.25
Nodes (13): ParsedCatalog, CATALOG_MAX_PAGE_SIZE, CATALOG_PAGE_SIZE, CatalogFilters, LinoleumPage, CatalogPage, CATALOG_CARD_SELECT, CatalogCardProduct (+5 more)
...
Cohesion: 0.21
Nodes (16): fetchWallpaperProducts(), buildViewOpenGraph(), buildWallpapersMetadata(), baseParamOf(), baseValueOf(), dynamic, firstParam(), generateMetadata() (+8 more)

### Community 23 - "shared.ts"
Cohesion: 0.14
Nodes (23): Home(), fetchProductBySlug(), fetchProductBySlugStore, fetchProducts(), CatalogCardImage, JUNCTION_COUNT_SELECT, LINOLEUM_ROOT_SLUG, normalizeProduct() (+15 more)
...
Cohesion: 0.08
Nodes (39): GET(), maxDuration, authUrl(), CachedAuthToken, categoriesUrl(), contentUrl(), FetchLike, getAuthToken() (+31 more)
...
### Community 30 - "createPaymentInit"
Cohesion: 0.18
Nodes (8): createPaymentInit(), errorOf(), InitDeps, methodOf(), nextAttemptOrderId(), OrdersGateway, paymentIdOf(), processLiqPayCallback()
...
Cohesion: 0.07
Nodes (48): buildApplySql(), buildOurPath(), buildRemapMapping(), buildSupplierPathIndex(), forecastRemap(), mapSelectionTree(), normalizeNameKey(), OurCategoryRow (+40 more)
...
### Community 39 - "react"
Cohesion: 0.06
Nodes (36): DraftItem, ListResponse, availabilityLabel(), CartPage(), metadata, TYPE_STYLES, CartBadge(), EmptyState() (+28 more)

### Community 40 - "telegram.ts"
Cohesion: 0.08
Nodes (33): asNumber(), asString(), asStringOrNull(), buildOrderNotificationKeyboard(), buildOrderNotificationMessage(), deliveryPaymentIntent(), describeDelivery(), lastAlertAt (+25 more)
...
Cohesion: 0.04
Nodes (39): StagedContentRow, db, root, batches, client, EXCLUDE_EMPTY_HTML_DESC_IDS, root, runIdx (+31 more)
...
Cohesion: 0.12
Nodes (22): cronAuthorized(), GET(), maxDuration, encodeLiqPayData(), fetchLiqPayProviderStatus(), ReconciliationCase, ALERT_CLASSES, AlertClass (+14 more)

### Community 50 - "enforceRateLimit"
Cohesion: 0.08
Nodes (34): ImageRow(), CheckpointRow, GET(), POST(), supabase, cronAuthorized(), GET(), maxDuration (+26 more)

### Community 51 - "isUuid"
Cohesion: 0.15
Nodes (30): DELETE(), PUT(), POST(), POST(), SiblingRow, PUT(), POST(), DELETE() (+22 more)
...
Cohesion: 0.07
Nodes (32): metadata, metadata, Announcements(), CALLBACK_TIMEOUT_MS, CallbackRequest(), Status, GlueCrossSell(), availabilityLabel() (+24 more)
...
Cohesion: 0.17
Nodes (12): PayWithLiqPayButton(), startPayment(), carrierLabel(), trackingUrl(), isPendingAttemptStale(), GuestOrderViewPage(), ItemRow, OrderRow (+4 more)
...
Cohesion: 0.21
Nodes (15): clampInt(), GET(), maxDuration, parseIso(), ReconciliationOrderRow, mapLiqPayStatus(), sameMoneyCents(), classifyReconcileRow() (+7 more)
...
Cohesion: 0.09
Nodes (27): FavoriteButton(), FavoritesBadge(), HeartIcon(), RemoveFavoriteButton(), WebAnalytics(), FavoritesPage(), geistMono, geistSans (+19 more)
...
Cohesion: 0.14
Nodes (19): intUk, LinoleumMeterPanel(), LinoleumMeterPanelProps, LinoleumWidthOption, parsePositive(), pickDefaultWidthId(), sortWidthOptions(), widthValueOf() (+11 more)
...
### Community 85 - "formatPrice"
Cohesion: 0.09
Nodes (22): buildActiveChips(), StarIcon(), ItemReviewForm(), ItemRow, OrderDetails, OrderDetailsCard(), dateFormatter, pluralReviews() (+14 more)
...
Cohesion: 0.14
Nodes (27): ExistingProduct, findSpecValue(), formatWidthM(), LinoleumPlan, PRICE_SQM_SPEC_NAME, WIDTH_SPEC_NAME, ConsolidationPlan, hideLegacyProducts() (+19 more)

### Community 90 - "linoleum/filtered/page.tsx"
Cohesion: 0.19
Nodes (18): CatalogSort, fetchLinoleumProducts(), buildLinoleumBreadcrumbJsonLd(), buildLinoleumMetadata(), dynamic, firstParam(), generateMetadata(), LinoleumFilteredPage() (+10 more)
...
Cohesion: 0.10
Nodes (33): LINOLEUM_SKU_PREFIX, buildConsolidatedSpecifications(), buildVariantPlanRow(), designKey(), ExistingCategoryRow, ExistingVariant, expectedMinPrice(), formatPriceSqmValue() (+25 more)
...
### Community 105 - "admin-shipment-prefill.ts"
Cohesion: 0.19
...
Cohesion: 0.05
Nodes (59): detectImageMime(), CliDeps, createServiceClient(), DEFAULT_PHOTOS_PATH, DesignAttachPlan, DesignFailure, DesignPhoto, DesignPhotoBase (+51 more)
...
Cohesion: 0.06
Nodes (36): buildDescriptionStats(), buildImagesStats(), buildParamsStats(), coerceParams(), coercePictures(), DedupeResult, DescriptionStats, ImagesStats (+28 more)
...
Cohesion: 0.06
Nodes (50): BrandsPage(), revalidate, ActiveChip, catalogHeading(), catalogPageUrl(), CatalogView(), catalogViewMetadata(), CatalogViewProps (+42 more)
...
Cohesion: 0.15
Nodes (18): BOILERPLATE_MARKERS, BOILERPLATE_PREFIXES, buildCatalogViewMetadata(), buildProductTitleName(), CatalogIndexInput, CatalogViewMetadataArgs, decideCatalogIndexing(), IndexingDecision (+10 more)
...
### Community 172 - "api/feedback/route.ts"
Cohesion: 0.23
...
Cohesion: 0.11
Nodes (25): AdminCategoryMultiSelect(), CategorySelect(), Category, applyCategorySeoMetadata(), CatalogViewFiltersLike, CategorySeoOverride, filterNonEmptyChildren(), getCategorySeo() (+17 more)
...
Cohesion: 0.06
Nodes (26): @supabase/supabase-js, svc, escape(), rows, statements, svc, bySku, c (+18 more)

### Community 189 - "checkout-unavailable-items.test.ts"
Cohesion: 0.22
Nodes (6): root, form(), root, src(), summary(), root

### Community 190 - "og-metadata.test.ts"
Cohesion: 0.18
Nodes (6): root, pdp(), CATALOG_LIB_FILES, catalogLib(), root, src()
...
### Community 201 - "favorites-context.test.ts"
Cohesion: 0.38
Nodes (4): installWindow(), loadWith(), StorageStub, uninstallWindow()

### Community 202 - "success/page.tsx"
Cohesion: 0.10
Nodes (25): POST(), supabase, parseBody(), POST(), supabase, CheckoutSuccessPage(), ItemRow, OrderRow (+17 more)
...
### Community 206 - "curated-selected.test.ts"
Cohesion: 0.40
...
### Community 219 - "yugcontract-categories-preview.ts"
Cohesion: 0.50
...
Cohesion: 0.10
Nodes (26): fetchActiveCategoriesStore, countBrandProductsStore, countBrandProductsUncached(), countCategoryBrandProductsStore, countCategoryBrandProductsUncached(), countCategoryProductsStore, countCategoryProductsUncached(), buildGlueCrossSellQuery() (+18 more)

### Community 231 - "schema-org.ts"
Cohesion: 0.07
Nodes (32): OrganizationJsonLd(), availabilityUrl(), BreadcrumbCategoryLike, BreadcrumbCategoryNode, buildCatalogBreadcrumbJsonLd(), buildOrganizationJsonLd(), buildProductBreadcrumbJsonLd(), buildProductJsonLd() (+24 more)
...
### Community 234 - "order-tracking.ts"
Cohesion: 0.23
...
### Community 246 - "yugcontract-runtime.test.ts"
Cohesion: 0.67
...
Cohesion: 0.05
Nodes (62): CheckoutForm(), SubmitResult, Carrier, DeliveryType, fetchDivisionsApi(), fetchUkrposhtaOfficesApi(), isNpWarehouseType(), NpDivision (+54 more)

### Community 326 - "api/orders/route.ts"
Cohesion: 0.13
Nodes (20): failedLookupCount(), POST(), supabase, POST(), SanitizedItem, sanitizeShippingInfo(), supabase, IDEMPOTENCY_KEY_MAX (+12 more)
...
Cohesion: 0.11
Nodes (24): DELETE(), GET(), invalidatePublicReads(), PATCH(), POST(), readJson(), DELETE(), DELETE() (+16 more)

### Community 342 - "product-description.ts"
Cohesion: 0.16
Nodes (9): ProductDescription(), NOTE: htmlToPlainText/isPlaceholderDescription live here (not in seo.ts), ResolvedDescription, resolveProductDescription(), pageSrc, root, specsSrc, root (+1 more)

## Knowledge Gaps
- **1604 isolated node(s):** `$schema`, `plugin`, `type`, `command`, `enabled` (+1599 more)
...
- **Why does `@supabase/supabase-js` connect `@supabase/supabase-js` to `order-payment-update.ts`, `search-suggest.test.ts`, `wallpaper-import.ts`, `admin-list.ts`, `content-import.ts`, `import-run.ts`, `merchant-feed.test.ts`, `wallpaper-photos.ts`, `linoleum-photos.ts`, `shared.ts`, `linoleum-import.ts`, `telegram-order-actions.ts`, `CatalogView.tsx`, `yugcontract-category-remap.ts`, `announcements.ts`, `telegram.ts`, `wallpapers/parse.ts`, `api/feedback/route.ts`, `reconciliation-scan.ts`, `enforceRateLimit`, `isUuid`, `package.json`, `normalize.ts`, `sitemap.ts`, `dry-run.ts`, `[orderNumber]/page.tsx`, `search-suggest.ts`, `ttn/route.ts`, `login/page.tsx`, `api/orders/route.ts`, `zero-result-report.ts`, `success/page.tsx`, `yugcontract-claim-cas.test.ts`, `glues-import.ts`, `wallpaper-publish.test.ts`, `linoleum/parse.ts`, `requireAdminApi`, `wallpaper-photo-sources.test.ts`, `linoleum-consolidate.ts`, `rate-limit.ts`, `products/route.ts`, `yugcontract-category-apply.test.ts`, `order-tracking.ts`, `catalog-health.ts`?**
  _High betweenness centrality (0.180) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `analytics.ts`, `CatalogView.tsx`, `orders/page.tsx`, `reconciliation/page.tsx`, `announcements.ts`, `ProductGallery.tsx`, `CheckoutForm.tsx`, `(dashboard)/categories/page.tsx`, `filter-url.ts`, `package.json`, `normalize.ts`, `products/page.tsx`, `category-tree.ts`, `[id]/page.tsx`, `[slug]/page.tsx`, `RecentlyViewedTracker.tsx`, `[orderNumber]/page.tsx`, `search-suggest.ts`, `login/page.tsx`, `favorites/page.tsx`, `LinoleumMeterPanel.tsx`, `(dashboard)/brands/page.tsx`, `next`, `cart-context.tsx`, `formatPrice`, `product-description.ts`, `fetchActiveCategories`, `SiteFooter.tsx`, `counts.ts`, `RollCalculator.tsx`, `feedback/page.tsx`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `enforceRateLimit()` connect `enforceRateLimit` to `novapost/delivery-cost.ts`, `api/orders/route.ts`, `import-run.ts`, `ukrposhta/errors.ts`, `offices.ts`, `api/feedback/route.ts`, `success/page.tsx`, `rate-limit.ts`, `getNovaPostClient`, `UkrposhtaError`, `normalize.ts`, `yugcontract/client.ts`, `NovaPostError`, `search-suggest.ts`?**
