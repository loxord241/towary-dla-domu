...
## Corpus Check
- 633 files · ~1,236,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3866 nodes · 7009 edges · 304 communities (215 shown, 66 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 64 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `87d690a9`
...
6. `fetchActiveCategories()` - 25 edges
7. `NovaPostError` - 25 edges
8. `run()` - 25 edges
9. `CatalogView()` - 24 edges
10. `createPaymentInit()` - 23 edges
...
## Communities (304 total, 66 thin omitted)

### Community 0 - "order-payment-update.ts"
Cohesion: 0.11
Nodes (21): LiqPayConfig, ApplyResult, buildCheckoutPayload(), CallbackDeps, CallbackOrderRow, CallbackOutcome, CheckoutPayloadInput, createPaymentInit() (+13 more)
...
### Community 4 - "schema-org.ts"
Cohesion: 0.09
Nodes (23): OrganizationJsonLd(), availabilityUrl(), BreadcrumbCategoryLike, buildCatalogBreadcrumbJsonLd(), buildOboiBreadcrumbJsonLd(), buildOrganizationJsonLd(), buildProductBreadcrumbJsonLd(), buildProductJsonLd() (+15 more)
...
Cohesion: 0.12
Nodes (30): assertContentFields(), claimNextContentBatch(), CONTENT_BATCH_SIZE, CONTENT_STALE_RUNNING_MS, ContentBatchOutcome, ContentBatchRow, ContentPlan, contentProductQueryIds() (+22 more)
...
Cohesion: 0.10
Nodes (34): ActiveChip, buildActiveChips(), catalogHeading(), catalogPageUrl(), CatalogView(), catalogViewMetadata(), CatalogViewProps, firstParam() (+26 more)
...
Cohesion: 0.11
Nodes (34): GET(), fetchCatalogProducts(), fetchPublishedReviews(), fetchPublishedReviewsStore, fetchReviewSummary(), fetchReviewSummaryStore, ProductReview, REVIEWS_PAGE_SIZE (+26 more)

### Community 15 - "shared.ts"
Cohesion: 0.14
Nodes (21): Home(), metadata, revalidate, fetchProductBySlug(), fetchProductBySlugStore, fetchProducts(), CATALOG_DICTIONARY_TTL_SECONDS, CatalogCardImage (+13 more)
...
Cohesion: 0.07
Nodes (38): GET(), PUT(), SHIPMENT_SELECT, CARGO_CATEGORIES, CargoCategory, isRecord(), MAX_PARCELS_PER_SHIPMENT, MAX_SHIPMENTS (+30 more)
...
Cohesion: 0.13
Nodes (24): GET(), revalidate, fetchActiveBrands(), fetchActiveBrandsCached, fetchActiveBrandsStore, fetchActiveCategories(), fetchActiveCategoriesCached, CatalogSort (+16 more)
...
Cohesion: 0.18
Nodes (16): ImageRow(), GlueCrossSell(), ProductCard(), RelatedProducts(), fetchGlueCrossSell, shouldRenderDescriptionSection(), getMainPublicImageUrl(), getPublicImageUrl() (+8 more)
...
Cohesion: 0.08
Nodes (16): TelegramSendResult, RESTOCK_MAX_EMAILS_PER_PRODUCT, RESTOCK_MAX_PRODUCTS, RestockDigestEntry, RestockProductRow, RestockRequestRow, cliCode, componentCode (+8 more)

### Community 39 - "icons.tsx"
Cohesion: 0.19
Nodes (17): TYPE_STYLES, base(), BoxIcon(), CartIcon(), CheckIcon(), ChevronRightIcon(), FilterIcon(), HeartIcon() (+9 more)
...
Cohesion: 0.13
Nodes (11): metadata, metadata, CardAddToCartButton(), CartBadge(), SiteHeader(), useCart(), MAZEPY_83A_PHOTOS, MAZEPY_PHOTOS (+3 more)
...
Cohesion: 0.14
Nodes (19): POST(), supabase, isCallbackUuid(), isValidCallbackName(), POST(), serviceClient(), isRestockUuid(), isValidRestockEmail() (+11 more)

### Community 51 - "SiteFooter.tsx"
Cohesion: 0.14
Nodes (14): POST(), serviceClient(), ErrorKind, FeedbackModal(), Status, INFO_LINKS, SiteFooterProps, FEEDBACK_DAILY_CAP (+6 more)
...
Cohesion: 0.06
Nodes (40): CategoriesResponse, YugcontractCategoriesPage(), PreviewResponse, YugcontractAdminPage(), errorResponse(), fetchAllRows(), GET(), maxDuration (+32 more)
...
### Community 55 - "counts.ts"
Cohesion: 0.12
Nodes (19): fetchActiveCategoriesStore, countBrandProductsStore, countBrandProductsUncached(), countCategoryProductsStore, countCategoryProductsUncached(), cachePublicRead(), ELIGIBLE_COUNT_SELECT, JUNCTION_COUNT_SELECT (+11 more)
...
Cohesion: 0.08
Nodes (23): FaqJsonLd(), FaqSection(), ProductJsonLd(), FaqItem, isWallpaperCategorySlug(), WALLPAPER_FAQ, buildPageWindow(), PageWindowItem (+15 more)
...
### Community 63 - "NavDrawer.tsx"
Cohesion: 0.19
Nodes (10): NavDrawer(), PINNED_CATEGORIES, SHOP_LINKS, SiteFooter(), FooterCategoryInput, footerCategoryLabel(), MAX_FOOTER_CATEGORY_LINKS, MERCH_CATEGORIES (+2 more)
...
Cohesion: 0.15
Nodes (15): FavoriteButton(), FavoritesBadge(), availabilityLabel(), ProductCardData, RemoveFavoriteButton(), FavoritesContext, FavoritesContextValue, FavoritesProvider() (+7 more)
...
Cohesion: 0.08
Nodes (26): CheckoutSuccessPage(), ItemRow, OrderRow, SearchParams, supabase, ItemReviewForm(), ItemRow, OrderDetails (+18 more)
...
Cohesion: 0.09
Nodes (41): CheckoutForm(), SubmitResult, Carrier, DeliveryType, fetchDivisionsApi(), fetchUkrposhtaOfficesApi(), isNpWarehouseType(), NpDivision (+33 more)
...
Cohesion: 0.15
Nodes (19): maxDuration, POST(), maxDuration, POST(), ExistingBrandRow, BatchCounters, BatchOutcome, claimNextBatch() (+11 more)
...
### Community 103 - "favorites/page.tsx"
Cohesion: 0.18
Nodes (11): availabilityLabel(), CartPage(), EmptyState(), FavoritesPage(), fetchCartPreview(), FetchHandlers, PREVIEW_NETWORK_ERROR, PREVIEW_TIMEOUT_MS (+3 more)
...
### Community 132 - "RecentlyViewedTracker.tsx"
Cohesion: 0.27
...
### Community 145 - "wallpaper-import-cli.test.ts"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (24): DELETE(), PUT(), POST(), DELETE(), PUT(), POST(), POST(), supabase (+16 more)
...
Cohesion: 0.11
Nodes (23): htmlToPlainText(), isPlaceholderDescription(), BOILERPLATE_MARKERS, BOILERPLATE_PREFIXES, buildCatalogViewMetadata(), buildProductMetaDescription(), CatalogIndexInput, CatalogViewMetadataArgs (+15 more)
...
Cohesion: 0.11
Nodes (25): AdminCategoryMultiSelect(), CategorySelect(), ComboboxOption, FilterCombobox(), ChevronDownIcon(), Dictionaries, Brand, Category (+17 more)
...
Cohesion: 0.11
Nodes (20): GET(), GET(), invalidatePublicReads(), PATCH(), readJson(), DELETE(), GET(), POST() (+12 more)
...
### Community 204 - "description-drafts.ts"
Cohesion: 0.22
...
Cohesion: 0.18
Nodes (8): matchContentGoodsToProducts(), DU_BASE_TO_DU, DU_CONTENT_BY_DU_YC, DU_CONTENT_PAIRS, duBaseIdOf(), DuContentPair, duProduct(), product()
...
### Community 230 - "listing.ts"
Cohesion: 0.10
Nodes (29): ParsedCatalog, CATALOG_MAX_PAGE_SIZE, CATALOG_PAGE_SIZE, CatalogFilters, buildGlueCrossSellQuery(), fetchGlueCrossSellUncached(), GLUE_CATEGORY_SLUG, GLUE_CROSS_SELL_LIMIT (+21 more)
...
Cohesion: 0.11
Nodes (28): failedLookupCount(), POST(), supabase, POST(), supabase, POST(), SanitizedItem, sanitizeShippingInfo() (+20 more)
...
### Community 252 - "yugcontract/categories/route.ts"
Cohesion: 0.36
...
### Community 268 - "domains.ts"
Cohesion: 0.33
Nodes (4): domainOfSlug(), isWallpaperSlug(), WALLPAPER_SKU_PREFIX, root
...
Cohesion: 0.16
Nodes (8): ProductDescription(), NOTE: htmlToPlainText/isPlaceholderDescription live here (not in seo.ts), ResolvedDescription, resolveProductDescription(), pageSrc, root, specsSrc, root

### Community 287 - "app/layout.tsx"
Cohesion: 0.29
Nodes (5): WebAnalytics(), geistMono, geistSans, metadata, viewport

### Community 288 - "yugcontract-dry-run.ts"
Cohesion: 0.38
...
### Community 298 - "CallbackRequest.tsx"
Cohesion: 0.40
Nodes (3): CALLBACK_TIMEOUT_MS, CallbackRequest(), Status

### Community 300 - "RestockNotify.tsx"
Cohesion: 0.40
Nodes (3): RESTOCK_TIMEOUT_MS, RestockNotify(), Status

## Knowledge Gaps
- **1424 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `type`, `/home/loxord/.local/bin/graphify-mcp`, `graphify-out/graph.json` (+1419 more)
...
- **Why does `enforceRateLimit()` connect `enforceRateLimit` to `novapost/delivery-cost.ts`, `ukrposhta/errors.ts`, `payment/route.ts`, `NovaPostError`, `catalog.ts`, `offices.ts`, `rate-limit.ts`, `getNovaPostClient`, `UkrposhtaError`, `SiteFooter.tsx`, `normalize.ts`, `import-run.ts`, `search-suggest.ts`, `yugcontract/categories/route.ts`, `requireAdminApi`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `requireAdminApi()` connect `requireAdminApi` to `orders/[id]/route.ts`, `products/route.ts`, `admin-list.ts`, `ttn/route.ts`, `novapost/delivery-cost.ts`, `reconciliation.ts`, `order-tracking.ts`, `login/page.tsx`, `admin-shipments.ts`, `images/route.ts`, `dbErrorResponse`, `import-run.ts`, `normalize.ts`, `isUuid`, `[imageId]/route.ts`, `yugcontract/categories/route.ts`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `formatPrice()` connect `[orderNumber]/page.tsx` to `favorites-context.tsx`, `favorites/page.tsx`, `telegram.ts`, `CatalogView.tsx`, `CheckoutForm.tsx`, `[slug]/page.tsx`, `search-suggest.ts`?**
