...
## Corpus Check
- 283 files · ~350,793 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1799 nodes · 2927 edges · 158 communities (121 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4476718c`
...
Cohesion: 0.10
Nodes (24): LIQPAY_CHECKOUT_URL, LiqPayConfig, createLiqPaySignature(), decodeLiqPayData(), encodeLiqPayData(), verifyLiqPaySignature(), ApplyResult, buildCheckoutPayload() (+16 more)
...
Cohesion: 0.12
Nodes (20): Home(), CatalogPage, collectRelated(), fetchCatalogProducts(), fetchFeaturedProducts(), fetchPopularProducts(), fetchProductBySlug(), fetchProducts() (+12 more)
...
Cohesion: 0.06
Nodes (43): BRAND_SORT_KEYS, BrandsAdminPage(), fetchBrandList(), SORT_OPTIONS, totalPagesFor(), CategoriesAdminPage(), CATEGORY_SORT_KEYS, fetchAllCategoriesForPicker() (+35 more)
...
### Community 20 - "[slug]/page.tsx"
Cohesion: 0.21
Nodes (12): AddToCartButton(), AddToCartButtonProps, VariantOption, GalleryImage, ProductGallery(), fetchPublishedReviews(), fetchReviewSummary(), availabilityLabel() (+4 more)
...
### Community 22 - "RecentProducts.tsx"
Cohesion: 0.27
...
Cohesion: 0.11
Nodes (23): authUrl(), CachedAuthToken, categoriesUrl(), contentUrl(), FetchLike, getAuthToken(), getContentGoods(), getContentGoodsWithMeta() (+15 more)
...
Cohesion: 0.17
Nodes (14): availabilityLabel(), CartPage(), CheckoutForm(), SubmitResult, CartBadge(), EmptyState(), useCart(), CartPreviewLine (+6 more)
...
Cohesion: 0.20
Nodes (9): FINAL_FAILED, FINAL_PAID, FINAL_REFUNDED, isKnownLiqPayStatus(), isKnownNonFinalLiqPayStatus(), KNOWN_NON_FINAL, mapLiqPayStatus(), PaymentStatus (+1 more)
...
Cohesion: 0.14
Nodes (8): collectExpandedIds(), ExpandableNode, ExpansionResult, flattenSelectedIds(), SELECTED_CATEGORIES, YcSelectedCategory, raw(), EXISTING_ROW
...
### Community 70 - "supabase-storage.ts"
Cohesion: 0.33
Nodes (6): ImageRow(), RelatedProducts(), Product, getMainPublicImageUrl(), getPublicImageUrl(), getPublicImageUrls()
...
Cohesion: 0.30
Nodes (6): metadata, FavoritesBadge(), RemoveFavoriteButton(), SiteHeader(), FavoritesPage(), useFavorites()
...
### Community 93 - "ProductDescription.tsx"
Cohesion: 0.32
...
### Community 141 - "ProductReviews.tsx"
Cohesion: 0.29
...
Cohesion: 0.17
Nodes (17): POST(), supabase, parseBody(), POST(), supabase, orderAccessToken(), verifyOrderAccessToken(), buildCallbackUrl() (+9 more)

### Community 151 - "ProductSpecifications.tsx"
Cohesion: 0.36
Nodes (5): ProductSpecifications(), ProductSpecificationsRow, sanitizeSpecRows(), componentSrc, root

### Community 152 - "(home)/page.tsx"
Cohesion: 0.29
Nodes (6): CONTACT_EMAIL, INFO_LINKS, SiteFooter(), SiteFooterProps, metadata, revalidate
...
## Knowledge Gaps
- **704 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `metadata`, `revalidate`, `metadata` (+699 more)
...
- **Why does `enforceRateLimit()` connect `enforceRateLimit` to `normalize.ts`, `import-run.ts`, `yugcontract/categories/route.ts`, `liqpay-config.ts`?**
...
- **Why does `Product` connect `supabase-storage.ts` to `admin-list.ts`, `schema-org.ts`, `catalog.ts`, `products/page.tsx`, `[slug]/page.tsx`?**
