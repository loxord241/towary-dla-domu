  ...
  return (
    <InfoPage title="Доставка та оплата">
      <div className="space-y-4 text-base leading-relaxed text-gray-700">
        ...
        <section>
          <h2 className="text-xl font-semibold tracking-tight text-gray-900">
            Самовивіз у Кривому Розі — безкоштовно
          </h2>
          <p>Можете забрати замовлення самостійно — три пункти видачі:</p>
          <ul className="list-disc list-inside space-y-1">
            <li>{`вул. Гетьмана Івана Мазепи, 87А — побутова техніка;`}</li>
            <li>{`вул. Гетьмана Івана Мазепи, 83А — шпалери;`}</li>
            <li>{`вул. Гетьмана Івана Мазепи, 89А — лінолеум.`}</li>
          </ul>
          <p>
            {`Пункт видачі обирається під час оформлення замовлення. Якщо в
            кошику товари різних напрямків — замовлення чекатиме на обраній
            точці.`}
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            {`Онлайн — через платіжний сервіс LiqPay одразу після оформлення
            замовлення (картка будь-якого банку).`}
          </p>
          <p>
            {`Для самовивоза можна також розрахуватися готівкою безпосередньо
            на пункті видачі — оберіть відповідний варіант у кошику.`}
          </p>
        </section>
