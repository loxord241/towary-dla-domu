 ...
 * Третя точка — Мазепи 89А (лінолеум, рішення власника 2026-09-17): картка
 * з фотографіями (фото передав власник 2026-09-19), з контактним телефоном
 * магазину.
 */
...
// Фото третьої точки (власник, 2026-09-19): фасад, стелажі лінолеуму та
// асортимент залу.
const MAZEPY_89A_PHOTOS: PickupPointCard['photos'] = [
  { src: '/pickup/mazepy-89a-1.jpg', alt: 'Пункт видачі на вул. Гетьмана Івана Мазепи, 89А — фасад' },
  { src: '/pickup/mazepy-89a-2.jpg', alt: 'Пункт видачі на вул. Гетьмана Івана Мазепи, 89А — стелажі з лінолеумом' },
  { src: '/pickup/mazepy-89a-3.jpg', alt: 'Пункт видачі на вул. Гетьмана Івана Мазепи, 89А — лінолеум у залі' },
  { src: '/pickup/mazepy-89a-4.jpg', alt: 'Пункт видачі на вул. Гетьмана Івана Мазепи, 89А — водонагрівачі' },
  { src: '/pickup/mazepy-89a-5.jpg', alt: 'Пункт видачі на вул. Гетьмана Івана Мазепи, 89А — плінтуси та поріжки' },
  { src: '/pickup/mazepy-89a-6.jpg', alt: 'Пункт видачі на вул. Гетьмана Івана Мазепи, 89А — змішувачі' },
];
