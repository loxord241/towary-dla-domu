...
export const metadata: Metadata = {
  title: 'Товари для дому — побутова техніка, шпалери, лінолеум, посуд',
  description:
    'Побутова техніка, кухонний посуд, шпалери та лінолеум — понад 5 000 товарів. Доставка по Україні, самовивіз у Кривому Розі.',
    ...
    <div className="flex min-h-screen flex-col bg-gray-50">
      ...
      <section className="container mx-auto px-4 pb-10">
        <p className="mx-auto max-w-2xl text-center text-sm text-gray-600">
          Наші пункти самовивозу в Кривому Розі: техніка (Мазепи, 87А), шпалери
          (Мазепи, 83А), лінолеум (Мазепи, 89А). Детальніше на сторінці{' '}
          <Link href="/samovyviz" className="text-blue-600 hover:underline">
            Самовивіз
          </Link>
          .
        </p>
