  ...
  return (
    <InfoPage title="Політика конфіденційності">
      <div className="space-y-4 text-sm leading-relaxed text-gray-700">
        ...
        <section>
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">Зміст</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">1. Загальні поняття та сфера застосування</h3>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>{`відповідальна особа — визначена особа, яка організовує роботу, пов’язану із захистом персональних даних при їх обробці, відповідно до закону;`}</li>
            <li>{`володілець бази персональних даних — фізична або юридична особа, якій законом або за згодою суб’єкта персональних даних надано право на обробку цих даних, яка затверджує мету обробки персональних даних у цій базі даних, встановлює склад цих даних та процедури їх обробки, якщо інше не визначено законом;`}</li>
            <li>{`Державний реєстр баз персональних даних — єдина державна інформаційна система збору, накопичення та обробки відомостей про зареєстровані бази персональних даних;`}</li>
            <li>{`загальнодоступні джерела персональних даних — довідники, адресні книги, реєстри, списки, каталоги, інші систематизовані збірники відкритої інформації, які містять персональні дані, розміщені та опубліковані з відома суб’єкта персональних даних. Не вважаються загальнодоступними джерелами персональних даних соціальні мережі та інтернет-ресурси, в яких суб’єкт персональних даних залишають свої персональні дані (окрім випадків, коли суб’єктом персональних даних прямо зазначено, що персональні дані розміщені з метою їх вільного поширення та використання);`}</li>
            <li>{`згода суб’єкта персональних даних — будь-яке документоване, добровільне волевиявлення фізичної особи щодо надання дозволу на обробку її персональних даних відповідно до сформульованої мети їх обробки;`}</li>
            <li>{`знеособлення персональних даних — вилучення відомостей, які дають змогу ідентифікувати особу;`}</li>
            <li>{`обробка персональних даних — будь-яка дія або сукупність дій, здійснених повністю або частково в інформаційній (автоматизованій) системі та/або в картотеках персональних даних, які пов’язані зі збиранням, реєстрацією, накопиченням, зберіганням, адаптуванням, зміною, поновленням, використанням і поширенням (розповсюдженням, реалізацією, передачею), знеособленням, знищенням відомостей про фізичну особу;`}</li>
            ...
            <li>{`розпорядник бази персональних даних — фізична чи юридична особа, якій володільцем бази персональних даних або законом надано право обробляти ці дані. Не є розпорядником бази персональних даних особа, якій володільцем та/або розпорядником бази персональних даних доручено здійснювати роботи технічного характеру з базою персональних даних без доступу до змісту персональних даних;`}</li>
            <li>{`суб’єкт персональних даних — фізична особа, стосовно якої відповідно до закону здійснюється обробка її персональних даних;`}</li>
            <li>{`третя особа — будь-яка особа, за винятком суб’єкта персональних даних, володільця чи розпорядника бази персональних даних та уповноваженого державного органу з питань захисту персональних даних, якій володільцем чи розпорядником бази персональних даних здійснюється передача персональних даних відповідно до закону;`}</li>
            <li>{`особливі категорії даних — персональні дані про расове або етнічне походження, політичні, релігійні або світоглядні переконання, членство в політичних партіях та професійних спілках, а також даних, що стосуються здоров’я чи статевого життя.`}</li>
          </ul>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">2. Перелік баз персональних даних</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">3. Мета обробки персональних даних</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">{`4. Порядок обробки персональних даних: отримання згоди, повідомлення про права та дії з персональними даними суб’єкта персональних даних`}</h3>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>{`відмітка на електронній сторінці документа чи в електронному файлі, що обробляється в інформаційній системі на основі документованих програмно-технічних рішень (натискання чекбокса при оформленні замовлення на сайті towary-dla-domu.com).`}</li>
          </ul>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">5. Місцезнаходження бази персональних даних</h3>
          <p>{`5.1. Вказані у розділі 2 цього Положення бази персональних даних знаходяться за адресою продавця.`}</p>
        </section>

        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">6. Умови розкриття інформації про персональні дані третім особам</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">{`7. Захист персональних даних: способи захисту, відповідальна особа, працівники, які безпосередньо здійснюють обробку та/або мають доступ до персональних даних у зв’язку з виконанням своїх службових обов’язків, строк зберігання персональних даних`}</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">8. Права суб’єкта персональних даних</h3>
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">9. Порядок роботи з запитами суб’єкта персональних даних</h3>
          ...
          <p>{`9.3. Суб’єкт персональних даних подає запит щодо доступу (далі — запит) до персональних даних володільцю бази персональних даних. У запиті зазначаються:`}</p>
          <ul className="list-disc list-inside space-y-1">
        ...
        <section className="space-y-3">
          <h3 className="text-lg font-semibold tracking-tight text-gray-900">10. Державна реєстрація бази персональних даних</h3>
