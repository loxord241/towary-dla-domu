...
const nextConfig: NextConfig = {
  ...
  // _du product URLs (97 same-price pairs from the 2026-08-31 audit,
  // generated by scripts/yugcontract-du-redirect-allowlist.ts into
  // app/lib/du-redirects.json) redirect permanently to their base product.
  // statusCode 301 (not permanent: true, which yields 308); the 6 price-diff
  // pairs and 26 orphans are intentionally NOT redirected.
  async redirects() {
