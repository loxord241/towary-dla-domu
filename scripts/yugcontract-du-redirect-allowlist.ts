 ...
 * 123 verified _du↔base pairs (name/brand/category 100% equal; slug derivation
 * verified 123/123; prices equal at audit time EXCEPT the price-diff list).
 ...
 * (business decision pending; both prices kept for the decision). The price-diff
 * id set is unchanged since 2026-09-02 (the run that removed the stale 301s of
 * the 9 former redirect pairs); 6381053_du is the only net-new pair since then.
